(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[31],{BxIY:function(e,n,r){"use strict"
var t=r("An8g")
var o=r("Ff2n")
var a=r("pQTu")
var i=r("m0r6")
...
y.defaultProps={padding:"small",errorImageUrl:f.a,footer:null,title:null,closeButtonSize:"small"}
function y(e){let n=e.padding,r=e.errorSubject,a=e.errorCategory,i=e.errorImageUrl,s=e.label,b=e.title,f=e.onDismiss,y=e.children,k=e.footer,_=e.closeButtonSize,B=Object(o["a"])(e,["padding","errorSubject","errorCategory","errorImageUrl","label","title","onDismiss","children","footer","closeButtonSize"])
null==b&&(b=s)
return l.a.createElement(v["a"],Object.assign({label:s,onDismiss:f},B),Object(t["a"])(v["a"].Header,{},void 0,Object(t["a"])(p["a"],{},void 0,Object(t["a"])(p["a"].Item,{grow:true},void 0,Object(t["a"])(h["a"],{},void 0,b)),Object(t["a"])(p["a"].Item,{},void 0,Object(t["a"])(d["a"],{onClick:f,size:_},void 0,c.t("Close"))))),Object(t["a"])(v["a"].Body,{padding:n},void 0,Object(t["a"])(u["a"],{as:"div",height:"100%"},void 0,Object(t["a"])(m["a"],{errorComponent:Object(t["a"])(g["a"],{imageUrl:i,errorSubject:r,errorCategory:a})},void 0,y))),k&&Object(t["a"])(v["a"].Footer,{},void 0,"function"===typeof k?k():k))}},"L+/K":function(e,n,r){"use strict"
var t=r("1OyB")
var o=r("vuIU")
var a=r("md7G")
var i=r("foSv")
...
return n.apply(this,arguments)}Object(o["a"])(r,[{key:"render",value:function(){return l.a.createElement(j["a"],Object.assign({},this.props,{name:"IconNo",viewBox:"0 0 1920 1920"}),S)}}])
...
var n=Object(C["a"])(r)
function r(){Object(t["a"])(this,r)
return n.apply(this,arguments)}Object(o["a"])(r,[{key:"render",value:function(){return l.a.createElement(j["a"],Object.assign({},this.props,{name:"IconInfoBorderless",viewBox:"0 0 1920 1920"}),L)}}])
r.displayName="IconInfoBorderlessSolid"
return r}(s["Component"])
R.glyphName="info-borderless"
R.variant="Solid"
R.propTypes=Object(O["a"])({},j["a"].propTypes)
var x=r("97gy")
var E=l.a.createElement("g",{fillRule:"evenodd",stroke:"none",strokeWidth:"1"},l.a.createElement("path",{d:"M994.578 1436.356c-133.365 0-241.822 108.457-241.822 241.822S861.213 1920 994.578 1920s241.822-108.457 241.822-241.822-108.457-241.822-241.822-241.822zM1165.063 1315.444L1310.156 0H679l145.093 1315.444z"}))
var w=function(e){Object(c["a"])(r,e)
var n=Object(C["a"])(r)
function r(){Object(t["a"])(this,r)
return n.apply(this,arguments)}Object(o["a"])(r,[{key:"render",value:function(){return l.a.createElement(j["a"],Object.assign({},this.props,{name:"IconWarningBorderless",viewBox:"0 0 1920 1920"}),E)}}])
r.displayName="IconWarningBorderlessSolid"
return r}(s["Component"])
w.glyphName="warning-borderless"
w.variant="Solid"
w.propTypes=Object(O["a"])({},j["a"].propTypes)
var A=r("XQb/")
var z=r("J2CL")
var N=r("BTe1")
function T(e){var n=e.colors,r=e.borders,t=e.spacing,o=e.typography,a=e.shadows
return{background:n.backgroundLightest,color:n.textDarkest,marginTop:t.small,borderRadius:r.radiusMedium,borderWidth:r.widthMedium,borderStyle:r.style,contentPadding:"".concat(t.small," ").concat(t.medium),contentFontSize:o.fontSizeMedium,contentFontFamily:o.fontFamily,contentFontWeight:o.fontWeightNormal,contentLineHeight:o.lineHeightCondensed,closeButtonMarginTop:t.xSmall,closeButtonMarginRight:t.xxSmall,iconColor:n.textLightest,successBorderColor:n.borderSuccess,successIconBackground:n.backgroundSuccess,infoBorderColor:n.borderInfo,infoIconBackground:n.backgroundInfo,warningBorderColor:n.borderWarning,warningIconBackground:n.backgroundWarning,dangerBorderColor:n.borderDanger,dangerIconBackground:n.backgroundDanger,boxShadow:a.depth2}}T.canvas=function(e){return{color:e["ic-brand-font-color-dark"]}}
...
var K=(M=Object(f["a"])("7.0.0",{closeButtonLabel:"renderCloseButtonLabel"}),D=Object(z["j"])(T,G),M(F=D(F=(W=U=function(e){Object(c["a"])(n,e)
function n(e){var r
Object(t["a"])(this,n)
...
e.setAttribute("aria-atomic",this.props.isLiveRegionAtomic)}}},{key:"createScreenreaderContentNode",value:function(){return l.a.createElement(B["a"],null,this.props.children)}},{key:"createScreenreaderAlert",value:function(){var e=this.getLiveRegion()
...
return l.a.createElement("div",{className:G.icon},l.a.createElement(n,{className:G.alertIcon}))}},{key:"renderCloseButton",value:function(){var e=this.props.renderCloseButtonLabel&&Object(y["a"])(this.props.renderCloseButtonLabel)||this.props.closeButtonLabel
return e?l.a.createElement("div",{className:G.closeButton,key:"closeButton"},l.a.createElement(k["a"],{onClick:this.close,size:"small",screenReaderLabel:e})):null}},{key:"renderAlert",value:function(){var e=this.variantUI(),n=e.classNames
return l.a.createElement(_["a"],{as:"div",margin:this.props.margin,className:n,onKeyUp:this.handleKeyUp},this.renderIcon(),l.a.createElement("div",{className:G.content},this.props.children),this.renderCloseButton())}},{key:"render",value:function(){if(this.props.screenReaderOnly){this.getLiveRegion()
return null}if("none"===this.props.transition)return this.state.open?this.renderAlert():null
return l.a.createElement(A["a"],{type:this.props.transition,transitionOnMount:true,in:this.state.open,unmountOnExit:true,onExited:this.onExitTransition},this.renderAlert())}}])
n.displayName="Alert"
...
//# sourceMappingURL=31-c-afdd524da4.js.map