(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[358,660,669,682,683,739],{"/iD7":function(e,t,n){"use strict"
var o=n("pQTu")
var i=n("m0r6")
...
p[g]=h((function(e,t,n,o,i){this.compilerInfo=[4,">= 1.0.0"]
...
var n=this.props,i=n.wrap,a=n.weight,r=n.fontStyle,s=n.size,l=n.lineHeight,c=n.letterSpacing,u=n.transform,b=n.color,_=n.children
var p=Object(f["a"])(t,this.props)
return d.a.createElement(p,Object.assign({},Object(m["a"])(this.props,t.propTypes),{className:h()((e={},Object(o["a"])(e,O.root,true),Object(o["a"])(e,O[s],s),Object(o["a"])(e,O["wrap-".concat(i)],i),Object(o["a"])(e,O["weight-".concat(a)],a),Object(o["a"])(e,O["style-".concat(r)],r),Object(o["a"])(e,O["transform-".concat(u)],u),Object(o["a"])(e,O["lineHeight-".concat(l)],l),Object(o["a"])(e,O["letterSpacing-".concat(c)],c),Object(o["a"])(e,O["color-".concat(b)],b),e)),ref:this.props.elementRef}),_)}}])
t.displayName="Text"
...
let o=n.offset(),a=n.outerWidth(),r=n.outerHeight(),s=o.top,l=s+r,c=o.left,d=c+a,u="html,body"==this.selector?i.a.windowScrollTop():this.scrollTop(),b=this.scrollLeft(),_=this.outerHeight(),h=this.outerWidth()
...
l-=e.top
c-=e.left
d-=e.left}if("HTML"==this[0].tagName||"BODY"==this[0].tagName){_=i()(window).height()
...
var A=(O=Object(g["a"])("7.0.0",{label:"renderLabel",required:"isRequired",inline:"display"}),U=Object(x["j"])(B,q),O(z=U(z=(S=C=function(e){Object(s["a"])(n,e)
var t=Object(l["a"])(n)
function n(e){var o
Object(a["a"])(this,n)
o=t.call(this)
...
var t=this.props,n=t.type,a=t.size,r=t.htmlSize,s=(t.display,t.textAlign),l=t.placeholder,c=t.value,u=t.defaultValue,b=t.required,_=t.isRequired,p=Object(i["a"])(t,["type","size","htmlSize","display","textAlign","placeholder","value","defaultValue","required","isRequired"])
var g=Object(f["b"])(p)
var m=this.interaction
var y=(e={},Object(o["a"])(e,q.input,true),Object(o["a"])(e,q[a],a),Object(o["a"])(e,q["textAlign--".concat(s)],s),e)
var v=""
...
function _(){return document.getElementById("flash_screenreader_holder")}function h(e){let t=e.label,n=e.closeButtonLabel,a=e.onDismiss,c=e.children,d=Object(i["a"])(e,["label","closeButtonLabel","onDismiss","children"])
return r.a.createElement(b["a"],Object.assign({liveRegion:_},d,{label:t,onDismiss:a}),Object(o["a"])(b["a"].Header,{},void 0,Object(o["a"])(s["a"],{"data-testid":"instui-modal-close",placement:"end",offset:"medium",onClick:a},void 0,n||u.t("Close")),Object(o["a"])(l["a"],{},void 0,t)),c)}["Header","Body","Footer"].forEach(e=>h[e]=b["a"][e])
...
return d?h(e):a}function g(e){var n=e-r
var o=e-s
var i=t-n
return u?Math.min(i,_-o):i}function f(e){var n=e-r
var o=e-s
...
var F=(O=Object(y["a"])("8.0.0",{ellipsis:"<TruncateText />"}),U=Object(j["a"])(),z=Object(f["j"])(w,A,B),O(C=U(C=z(C=(q=S=function(e){Object(c["a"])(t,e)
...
var n=this.props,a=n.border,r=n.children,s=n.color,l=n.level,c=n.margin,d=n.elementRef,b=n.ellipsis,_=Object(i["a"])(n,["border","children","color","level","margin","elementRef","ellipsis"])
var h=Object(v["a"])(t,this.props,(function(){return"reset"===l?"span":l}))
return u.a.createElement(g["a"],Object.assign({},Object(k["b"])(_),{className:p()((e={},Object(o["a"])(e,A.root,true),Object(o["a"])(e,A["level--".concat(l)],true),Object(o["a"])(e,A["color--".concat(s)],s),Object(o["a"])(e,A["border--".concat(a)],"none"!==a),Object(o["a"])(e,A.ellipsis,b),e)),as:h,margin:c,elementRef:d}),r)}}])
t.displayName="Heading"
return t}(d["Component"]),S.propTypes={border:_.a.oneOf(["none","top","bottom"]),children:m["a"],color:_.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","inherit"]),level:_.a.oneOf(["h1","h2","h3","h4","h5","reset"]),as:_.a.elementType,margin:f["c"].spacing,elementRef:_.a.func,ellipsis:_.a.bool},S.defaultProps={children:null,margin:void 0,elementRef:void 0,border:"none",color:"inherit",level:"h2"},q))||C)||C)||C)},mykf:function(e,t,n){"use strict"
...
o=[]
t={}
e.exports=n=function(e,n,i){var a,r,s,l,c,d,u,b,_
null==i&&(i=true)
...
a=(null!=n?n.decimal:void 0)||t.decimal}u=""+_+a+i
d=o[u]
if(null==d){s=i?3:1
...
//# sourceMappingURL=edit_rubric-c-3c1da68dae.js.map