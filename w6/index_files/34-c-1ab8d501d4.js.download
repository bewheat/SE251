...
document.body.appendChild(e)}return e}function l(e){c.a.render(Object(t["a"])(v,{message:n,timeout:Number.isNaN(parseInt(ENV.flashAlertTimeout,10))?f:ENV.flashAlertTimeout,error:r,variant:o,onClose:d.bind(null,e),screenReaderOnly:s}),e)}const g=document.createElement("div")
...
//# sourceMappingURL=34-c-1ab8d501d4.js.map