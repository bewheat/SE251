...
return e.split(/,\s*</).map(_).filter(o).reduce(d,{})}},"4Ogu":function(e,n,t){"use strict"
...
return"".concat(n,"?").concat(a)}async function l(e){let n=e.path,t=e.method,r=void 0===t?"GET":t,s=e.headers,d=void 0===s?{}:s,l=e.params,b=void 0===l?{}:l,u=e.body,g=e.fetchOpts,h=void 0===g?{}:g
const f=Object(a["a"])({},_["e"])
f.headers["X-CSRF-Token"]=Object(o["a"])("_csrf_token")
if(u&&"string"!==typeof u){u=JSON.stringify(u)
f.headers["Content-Type"]="application/json"}Object.assign(f.headers,d)
Object.assign(f,h)
...
e.response=v
throw e}const y=c()(v.headers.get("Link"))
...
const l=Object(c["lazy"])(()=>Promise.all([t.e(6),t.e(7),t.e(8),t.e(11),t.e(154),t.e(686)]).then(t.bind(null,"mftS")))
...
return _.a.createElement(i["a"],Object.assign({label:d.t("Copy To..."),placement:"end",onDismiss:s,padding:"medium"},o),Object(a["a"])(l,{sourceCourseId:n,contentSelection:t,onCancel:s}))}},U6jy:function(e,n){e.exports=a
...
function y(e){let n=e.padding,t=e.headerPadding,s=e.contentPadding,o=e.errorSubject,c=e.errorCategory,p=e.errorImageUrl,v=e.label,y=e.title,m=e.onDismiss,j=e.children,k=Object(r["a"])(e,["padding","headerPadding","contentPadding","errorSubject","errorCategory","errorImageUrl","label","title","onDismiss","children"])
null==t&&(t="0 0 ".concat(n," 0"))
null==y&&(y=v)
var S=Object(a["a"])(b["a"].Item,{grow:true},void 0,Object(a["a"])(u["a"],{ellipsis:true},void 0,y))
function C(){return Object(a["a"])(b["a"],{as:"div",padding:t},void 0,S,Object(a["a"])(b["a"].Item,{},void 0,Object(a["a"])(i["a"],{onClick:m,size:"small"},void 0,d.t("Close"))))}var O=Object(a["a"])(f["a"],{imageUrl:p,errorSubject:o,errorCategory:c})
...
const y=Object(i["lazy"])(()=>Promise.all([t.e(6),t.e(7),t.e(8),t.e(11),t.e(658)]).then(t.bind(null,"FB/m")))
function m(e){let n=e.contentShare,t=e.courseId,d=Object(o["a"])(e,["contentShare","courseId"])
const c=Object(i["useState"])([]),m=Object(s["a"])(c,2),j=m[0],k=m[1]
const S=Object(i["useState"])(null),C=Object(s["a"])(S,2),O=C[0],A=C[1]
const x=Object(i["useRef"])(d.open)
function E(){k([])
A(null)}function L(e){j.find(n=>n.id===e.id)||k(j.concat([e]))}function z(e){k(j.filter(n=>n.id!==e.id))}function I(){return Object(v["a"])({method:"POST",path:"/api/v1/users/self/content_shares",body:Object(r["a"])({},n,{receiver_ids:j.map(e=>e.id)})})}function T(){A("info")
...
return l.a.createElement(f["a"],Object.assign({label:_.t("Send To..."),size:"medium"},d,{footer:Object(a["a"])(B,{})}),Object(a["a"])(i["Suspense"],{fallback:R},void 0,F,Object(a["a"])(y,{courseId:t,selectedUsers:j,onUserSelected:L,onUserRemoved:z})))}},qBwj:function(e,n,t){"use strict"
var a=t("17x9")
var r=t("EUQ6")
...
Object(a["shape"])({id:a["string"].isRequired,name:a["string"].isRequired,content_type:Object(a["oneOf"])(_).isRequired,created_at:a["string"].isRequired,updated_at:a["string"].isRequired,read_state:a["string"].isRequired,sender:r["b"].isRequired,content_export:c})},xGaD:function(e,n,t){"use strict"
var a=t("An8g")
var r=t("Ff2n")
var s=t("pQTu")
var o=t("m0r6")
...
return _.a.createElement(i["a"],t,Object(a["a"])(c["Suspense"],{fallback:s},void 0,n))}}}])

//# sourceMappingURL=40-c-903da411ff.js.map