...
Object(S["a"])(a()(this).data("service").service,e=>{a()("#instructure_link_prompt").dialog("close")
...
r.dialog({width:425,height:"auto",title:"Link to Website URL",open(){a()(this).find(".prompt").focus().select()}})}function I(e,t){I.counter=I.counter||0
...
Promise.all([i.e(1),i.e(3),i.e(4),i.e(18),i.e(24),i.e(31),i.e(637)]).then(i.bind(null,"/wcz")).then(t=>{let i=t.default
const r=document.createElement("div")
document.body.appendChild(r)
M.a.render(Object(p["a"])(i,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(T["a"])(),resourceSelectionUrl:a()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),r,(function(){n=this}))})
const o=[]
const s=[]
...
U(e,s)
J(e,s)}if(o.length){const t=function(){const t=x.clumpedButtonMapping(o,e,e=>n.open(e))
...
t.icon="lti_tool_".concat(t.id)}t.iconSVG&&e.ui.registry.addIcon(t.icon,t.iconSVG)}function K(e,t){const i=v.t("Apps")
e.ui.registry.addButton("lti_tool_dropdown",{onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
document.dispatchEvent(e)},icon:"lti",tooltip:i,onSetup(t){x.showHideButtons(e)}})}function U(e,t){t.forEach(t=>{if(!t.favorite)return
W(e,t)
e.ui.registry.addButton("instructure_external_button_".concat(t.id),{onAction:t.onAction,tooltip:t.title,icon:t.icon,title:t.title})})}function J(e,t){const i=v.t("Apps")
e.ui.registry.addMenuButton("lti_mru_button",{tooltip:i,icon:"lti",fetch(i){i(Y(e,t))},onSetup(t){x.showHideButtons(e)}})}function Y(e,t){const i=JSON.parse(window.localStorage.getItem("ltimru"))
if(i&&Array.isArray(i)&&i.length){const r=t.filter(e=>i.includes(e.id))
const n=[]
r.forEach(t=>{W(e,t)
t.menuItem||(t.menuItem={type:"menuitem",text:t.title,icon:t.icon,onAction:t.onAction})
n.push(t.menuItem)})
n.sort((e,t)=>e.text.localeCompare(t.text))
n.push({type:"menuitem",text:v.t("View All"),onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
...
Promise.all([i.e(5),i.e(677)]).then(i.bind(null,"F+Bh")).then(t=>{let i=t.default
const n=new i(r.ed)
e.equationCB(n)})})
document.addEventListener("tinyRCE/initLinks",t=>{let i=t.detail
V.renderDialog(i.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([i.e(1),i.e(5),i.e(8),i.e(107),i.e(102),i.e(163),i.e(684)]).then(i.bind(null,"Dwgn")).then(i=>{let r=i.default
const n=new r(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(n)})})
document.addEventListener("tinyRCE/initEquella",t=>{i.e(751).then(i.bind(null,"gg/z")).then(i=>{let r=i.default
r(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{Z.init(t.detail.ed,t.detail.url,g["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([i.e(42),i.e(752)]).then(i.bind(null,"xR7n")).then(i=>{let r=i.default
r.insertEditor(t.detail.ed)
e.recordCB()})})}const X={call(e){if("exists?"===e)return true
...
const te={wrapEditor(e){const t=Object(r["a"])({},X,{},e)
return Object.assign(e,t)},wrapSidebar(e){const t=Object(r["a"])({},ee,{},e)
...
e="user"}else{var r=Object(re["a"])(ENV.context_asset_string,false)
var o=Object(n["a"])(r,2)
e=o[0]
t=o[1]
if("account"===e){e="user"
t=i}}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:{contextType:e,contextId:t,userId:i},contextType:e,contextId:t,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:d(ENV.JWT),themeUrl:ENV.active_brand_config_json_url,liveRegion:()=>document.getElementById("flash_screenreader_holder")}}let ae
const se={preload(e){(window.requestIdleCallback||window.setTimeout)(()=>this.loadRCE(e))},loadOnTarget(e,t,i){const r=this.getTargetTextarea(e)
const n=this.getRenderingTarget(r,t.getRenderingTarget)
const o=this.createRCEProps(r,t)
this.loadRCE(e=>{e.renderIntoDiv(n,o,e=>{e.mceInstance().on("init",()=>i(r,ie.wrapEditor(e)))})})},loadSidebarOnTarget(e,t){if(ENV.RICH_CONTENT_SKIP_SIDEBAR)return
const i=oe()
this.loadRCE(r=>{r.renderSidebarIntoDiv(e,i,e=>{t(ie.wrapSidebar(e))})})},loadingCallbacks:[],RCE:null,loadRCE(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:()=>{}
ae||(ae=(window.ENV.use_rce_enhancements?Promise.all([i.e(1),i.e(3),i.e(4),i.e(6),i.e(7),i.e(8),i.e(9),i.e(10),i.e(11),i.e(13),i.e(16),i.e(20),i.e(19),i.e(22),i.e(33),i.e(41),i.e(60),i.e(69),i.e(81),i.e(93),i.e(110),i.e(133),i.e(178),i.e(323)]).then(i.bind(null,"Idzl")):Promise.all([i.e(1),i.e(3),i.e(4),i.e(6),i.e(7),i.e(10),i.e(13),i.e(16),i.e(20),i.e(19),i.e(23),i.e(22),i.e(41),i.e(60),i.e(69),i.e(82),i.e(81),i.e(110),i.e(123),i.e(133),i.e(135),i.e(148),i.e(324)]).then(i.bind(null,"66gZ"))).then(e=>{this.RCE=e
Q()
return e}))
return ae.then(()=>{this.loadingCallbacks.forEach(e=>e(this.RCE))
...
const o=ENV.LOCALE
const a=Object.keys(ne["a"]).map(e=>({id:e,label:ne["a"][e]})).sort((e,t)=>e.id===o?-1:t.id===o?1:e.label.localeCompare(t.label,o))
...
return{defaultContent:e.value||t.defaultContent,editorOptions:m.bind(null,i,e.id,t,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:t.onFocus,onBlur:t.onBlur,textareaClassName:e.className,textareaId:e.id,trayProps:oe(),languages:a,autosave:s}}}
t["a"]=se}}])

//# sourceMappingURL=17-c-b1a5da8ece.js.map